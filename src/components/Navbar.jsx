...
const Navbar = () => {
  return (
    <React.Fragment>
      <nav className="navbar navbar-light fixed-top row my-0 py-1">
        <div className="justify-content-between ml-4">
          {/* Home */}
          <div id="homeDiv" className="nav-item d-inline-block ml-4 px-2">
          ...
          {/* Moments */}
          <div id="momentsDiv" className="nav-item d-inline-block px-2">
        ...
        {/* Search Chirper */}
        <div id="searchDiv" className="nav-item">
          <form id="searchForm" className="form-group mb-0" role="search">
